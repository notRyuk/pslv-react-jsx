            ...
            <main className="networkContainer">
                ...
                <div className="centerNetworkContainer content">
                        ...
                        {!requestIsLoading &&
                            (connectionRequests?.data?.length > 0 ?
                                connectionRequests?.data?.map((cr, i) => (
                                    ...
                                    connectionMutate={connectionMutate} requestMutate={requestMutate} user={cr.from} key={i} cr={cr} />
                    ...
                    <div className="card">
                        ...
                        <div className="suggestedConnection">
                            ...
                            {
                                !suggestIsLoading &&
                                (suggestedUser?.data?.length > 0 ? suggestedUser?.data?.map(eachUser => {
                                    return <SuggestedUserCard user={eachUser} key={eachUser._id} suggestMutate={suggestMutate} requestMutate={requestMutate} />
                ...
                <div className="rightNetworkContainer content">
                    <div className="card left-group">
                        ...
                        {
                            !connectionIsLoading &&
                            (connectedUser?.data?.length > 0 ? connectedUser?.data?.map(eachUser => {
                                return <ConnectedUser user={eachUser.users[0]} key={eachUser.users[0]._id} />
