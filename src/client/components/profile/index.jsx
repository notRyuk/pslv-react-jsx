...
const ProfileComponent = ({
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios.post(
      basePath + urls.user.profile.create,
      { address, role: session?.user?.role },
      {
        headers: {
          authorization: `Bearer ${session?.token}`,
        },
  ...
  useEffect(() => {
    ...
    if (updatedUserData) {
      toast.success(
        "Successfully updated profile photo! It may take some time to update in the overall website"
      );
    }
    if (updatedUserError) {
            ...
            <div className="card profileCard-profile">
              ...
              {tempUser?.data?._id === session.user._id && (
                <Link to="/edit-details">
                  <span className="material-symbols-rounded cover-edit">
                    edit
                  </span>
                </Link>
              )}
                  ...
                  <div className="edit-title">
                    <h3>
                      ...
                      <Chip
                        ...
                        label={tempUser?.data?.role.toUpperCase()}
                      />
                    </h3>
                  </div>
                    ...
                    <div className="modal-dialog">
                      ...
                      >
                        ...
                        <div className="modal-body" style={{color:"#fff"}}>
                          ...
                          <div className="mb-2">
                            Address Line 1 :{" "}
                            {tempUser?.data?.profile?.address.line1}
                          </div>
                          ...
                          <div className="mb-2">
                            Pincode :{" "}
                            {tempUser?.data?.profile?.address?.pinCode}
                          </div>
                          <div className="mb-2">
                          ...
                          <div className="mb-2">
                            Country :{" "}
                            {tempUser?.data?.profile?.address?.country}
                          </div>
                        </div>
                        <div className="modal-footer">
                          <button
              ...
              <div className="analytics-stats">
                <div>
                  ...
                  <div style={{ fontSize: "20px", textDecoration: "none" }}>
                    <Link to={others ? "#" : "/home"} className="linkStyle">
                ...
                {tempUser?.data.role === "alumni" && (
                  <div>
                    ...
                    <div style={{ fontSize: "20px", textDecoration: "none" }}>
                      <Link
                        to={others ? "#" : `/userJob/${params.id}`}
                        className="linkStyle"
                      >
                        {jobData?.data?.length} Referrals posted
                      </Link>
                      <div style={{ fontSize: "12px" }}>
                        Checkout the referrals posted by you.
                      </div>
                    </div>
                  </div>
                )}
                <div>
                  ...
                  <div style={{ fontSize: "20px", textDecoration: "none" }}>
                    <Link
                      to={session?.user._id !== params.id ? "#" : "/network"}
                      className="linkStyle"
                    >
                      {connectedUser?.data.length} connections
                    </Link>
                    <div style={{ fontSize: "12px" }}>
                ...
                <div className="profile-card card">
                    ...
                    >
                      {!others && (
                        <div>
                          ...
                          >
                            <span className="material-symbols-rounded about-edit">
                              add
                            </span>
                          </Link>
                        </div>
                  ...
                  <div className="education-container">
                    ...
                    >
                      ...
                      {tempUser?.data?.profile?.education?.length > 0 ? (
                        tempUser?.data?.profile?.education?.map((ed, id) => (
                          <div
                            style={{
                              fontSize: "12px",
                ...
                <div className="profile-card card">
                  ...
                  <div className="skill-container">
                    {tempUser?.data?.profile?.achievements?.length > 0 ? (
                      tempUser?.data?.profile?.achievements?.map(
                        (achievement, index) => (
                          <div key={index} className="skill-main">
                            <div
