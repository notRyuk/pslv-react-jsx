      ...
      <main className="twoColumnGrid">
        <div className="leftContent">
          <div className="card">
            ...
            <p style={{ marginBottom: '0.5rem', color: '#c8c8c8' }}>
            <span class="FAQ-ques"><b>3.Is Mascot free to use?</b></span><br /> 
            ...
            <p style={{ marginBottom: '0.5rem', color: '#c8c8c8' }}>
            <span class="FAQ-ques"><b>4.Can I search for jobs on Mascot?</b></span><br /> 
            ...
            <p style={{ marginBottom: '0.5rem', color: '#c8c8c8' }}>
            <span class="FAQ-ques"><b>5.Can I connect with people I don't know on Mascot?</b></span><br /> 
            ...
            <p style={{ marginBottom: '0.5rem', color: '#c8c8c8' }}>
            <span class="FAQ-ques"><b>6.Can I use Mascot to promote my business?</b></span><br /> 
            ...
            <p style={{ marginBottom: '0.5rem', color: '#c8c8c8' }}>
            <span class="FAQ-ques"><b>7.How do I get recommendations on Mascot?</b></span><br /> 
            ...
            <p style={{marginbottom: '0.5rem', color: '#c8c8c8' }}> 
            <span class="FAQ-ques"> <b>8.Can I use Mascot to publish articles and other content?</b> </span><br /> 
            ...
            <p style={{marginbottom: '0.5rem' , color: '#c8c8c8' }}>
             <span class="FAQ-ques"><b> 9.How can I make my Mascot profile stand out?</b></span><br /> 
            ...
            <p style={{marginbottom: '0.5rem', color: '#c8c8c8' }}> 
            <span class="FAQ-ques"><b>10.How can I protect my privacy on Mascot?</b></span><br /> 
